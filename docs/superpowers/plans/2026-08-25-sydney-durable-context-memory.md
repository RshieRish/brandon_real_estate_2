...
- [x] **Step 4: Deploy backend and worker with all four new flags false.** Staged deployments passed before promotion. Final exact-main backend `4a761b35-04b6-4ab2-8774-7ef20c5f072f` and worker `0b3bf3b5-ca82-4d26-b585-0502965fd7df` are `SUCCESS`; public health, worker `/ready`, database, migration, heartbeat, and job-registry checks pass.
