...
const REVIEWS = [
  {
    ...
    location: 'Lowell, MA',
    quote:
      'Brandon made the entire process seamless. He was always available to answer questions and truly fought for us during negotiations. Could not have asked for a better REALTOR\u00ae.',
    rating: 5 as const,
  },
  {
    author: 'Jacqui',
    ...
    quote:
      'As a first-time buyer I was terrified. Brandon broke everything down step by step and made sure I never felt lost. He found us the perfect home at the right price.',
    rating: 5 as const,
  },
  {
    author: 'Corey S.',
    ...
    quote:
      'Brandon helped us beat out multiple competing offers. His local market knowledge and negotiation skills are unmatched. We\u2019re in our dream home thanks to him.',
    rating: 5 as const,
  },
  {
    author: 'Erika R.',
    location: 'Sandown, NH',
    quote:
      'Responsive, professional, and genuinely cares about his clients. Brandon guided us through a complex purchase with ease. We\u2019d recommend him to anyone buying in MA or NH.',
    rating: 5 as const,
  },
];
    ...
    <>
      ...
      <section className="relative min-h-[100dvh] flex flex-col justify-center overflow-hidden bg-[#0a0a0a]">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(135deg, rgba(10,10,10,1) 0%, rgba(10,10,10,0.9) 55%, rgba(192,130,53,0.08) 100%)',
          }}
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pt-20 pb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-16 items-center">
            ...
            <div className="hidden lg:flex flex-col gap-1 border border-gold/20 bg-dark-card/60 backdrop-blur-sm p-8 min-w-[220px]">
              ...
              <div className="border-b border-dark-border pb-5 mb-5">
                <p className="text-gold font-black text-4xl leading-none">5&#9733;</p>
