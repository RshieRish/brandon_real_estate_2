...
const SELLER_REVIEWS = [
  {
    quote:
      'Brandon sold our home in under two weeks for over asking price. His marketing was unlike anything we had seen — constant updates, professional photos, and a strategy that just worked.',
    author: 'Valerie W.',
    location: 'Nashua, NH',
    rating: 5,
  },
  {
    quote:
      'We were nervous about selling in a shifting market. Brandon walked us through every step with confidence. He negotiated brilliantly and we could not be happier with the outcome.',
    author: 'Al & Elaine H.',
    location: 'Dracut, MA',
    rating: 5,
  },
  {
    quote:
      'From the first meeting to closing day, Brandon was professional, proactive, and genuinely cared about our family getting the best result. I recommend him to everyone I know.',
    author: 'Michelle R.',
    location: 'Lowell, MA',
    rating: 5,
  },
  {
    quote:
      'Brandon handled everything — staging advice, open houses, all the negotiations. Zero stress on our end. Sold for more than we expected. Absolute pro.',
    author: 'Jim R.',
    location: 'Dracut, MA',
    rating: 5,
  },
