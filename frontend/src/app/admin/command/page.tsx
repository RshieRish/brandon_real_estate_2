...
import { commandApi, type Celebrations, type Contact, type Overview, type Task } from '@/lib/command/api';
...
export default function CommandPage() {
  ...
  useEffect(() => { Promise.all([commandApi.overview(), commandApi.contacts(), commandApi.tasks(), commandApi.celebrations(new Date().getMonth() + 1)]).then(([o,c,t,celebrationData]) => { setOverview(o); setContacts(c); setTasks(t); setCelebrations(celebrationData); }).catch(e => setError(e.message)); }, []);
