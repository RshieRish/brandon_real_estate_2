...
class SydneyMemoryProvider(MemoryProvider):
    ...
    def system_prompt_block(self) -> str:
        ...
        return (
            ...
            "not the full audience. For birthday-only, home-anniversary-only, and "
            "combined celebration replies, keep audience checksums and audience "
            "references internal unless the current user explicitly asks to see "
            "that technical metadata. The general contact-audience instruction to "
            "report those identifiers does not apply to celebrations. If the tool "
            "is unavailable, state that you could "
